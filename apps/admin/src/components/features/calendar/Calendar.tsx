...
export default function Calendar() {
  ...
  const [events, setEvents] = useState<CalendarEvent[]>(() => {
    ...
    const twoDaysAfter = new Date(Date.now() + 259200000).toISOString().split("T")[0]
    return [
      ...
      { id: "3", title: "Workshop", start: dayAfter, end: twoDaysAfter, extendedProps: { calendar: "Primary" } },
    ]
  })
