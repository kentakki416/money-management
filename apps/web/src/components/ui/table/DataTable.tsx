...
export default function DataTable<T>({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
      ...
      {hasToolbar && (
        <div className="flex flex-col items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 sm:flex-row sm:items-center dark:border-gray-700">
          {pagination ? (
      ...
      <Table>
        ...
        <TableBody className="divide-y divide-gray-100 dark:divide-gray-700">
          {displayData.length === 0 ? (
            <TableRow>
              <TableCell className="px-5 py-10 text-center text-sm text-gray-400 dark:text-gray-500" colSpan={columns.length} key="empty">
              ...
              <TableRow key={getRowKey(row)}>
                {columns.map((col) => (
                  <TableCell
                    ...
                    className={
                      col.className ??
                      "px-5 py-4 text-sm text-gray-500 dark:text-gray-400"
                    }
                  >
                    {col.render
                      ? col.render(row)
      ...
      {pagination && (
        <div className="flex flex-col items-center justify-between gap-4 border-t border-gray-100 px-5 py-4 xl:flex-row dark:border-gray-700">
